...
public class ATM {
    ...
    public static void main(String[] args) {
        ...
        //init Bank
        Bank theBank = new Bank("Bank of Drousin");
    ...
    public static void transferFunds(User theUser, Scanner sc) {
        ...
        theUser.addAcctTransaction(fromAcct, -1 * amount, String.format("Transfer from account %s", theUser.getAccountUUID(toAcct)));
        theUser.addAcctTransaction(toAcct, amount, String.format("Transfer to account %s", theUser.getAccountUUID(fromAcct)));
    }

    /**
     * Process a fund withdraw from an account
     * @param theUser   the logged-in User object
     * @param sc        the Scanner objet user for user input
     */
